...
if __name__ == "__main__":
    ...
    ds, stream = setup_datastream(os.path.join(os.getenv("AAIPATH"), "deepmind-qa/cnn/questions/training"),
                                  os.path.join(os.getenv("AAIPATH"), "deepmind-qa/cnn/stats/training/vocab.txt"),
                                  DummyConfig())
