...
if __name__ == "__main__":
    ...
    # Build datastream
    path = os.path.join(os.getenv("AAIPATH"), "deepmind-qa/cnn/questions/training")
    valid_path = os.path.join(os.getenv("AAIPATH"), "deepmind-qa/cnn/questions/validation")
    vocab_path = os.path.join(os.getenv("AAIPATH"), "deepmind-qa/cnn/stats/training/vocab.txt")
